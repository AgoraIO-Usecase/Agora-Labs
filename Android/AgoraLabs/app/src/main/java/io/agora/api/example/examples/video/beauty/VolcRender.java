...
public class VolcRender {
    ...
    public void initExtension() {
        ...
        map.put(ID_VOLC_BUFFING,0);
        map.put(ID_VOLC_WHITEN,0);
        map.put(ID_VOLC_SHARPEN,0);
        map.put(ID_VOLC_THIN_FACE,0);
        map.put(ID_VOLC_NARROW_FACE,0);
        map.put(ID_VOLC_CHEEKBONE,0);
        map.put(ID_VOLC_LOWER_JAW,0);
        map.put(ID_VOLC_EYE,0);
        map.put(ID_VOLC_NOSE,0);
        map.put(ID_VOLC_MOUTH,0);
    }
    ...
    public void setSelectedFeatureID(int selectedFeatureID) {
        ...
        }else if(selectedFeatureID==ID_VOLC_LIP_STICK){
            setMakeup("lip/lite/fuguhong","Internal_Makeup_Lips");
        }else if(selectedFeatureID==ID_VOLC_BLUSH){
            setMakeup("blush/lite/weixun","Internal_Makeup_Blusher");
        } else if(selectedFeatureID==ID_VOLC_TRIMMING){
            setMakeup("facial/ziran","Internal_Makeup_Facial");
        }else if(selectedFeatureID==ID_VOLC_EYELASH){
            setMakeup("eyelashes/juanqiao","");
        }else if(selectedFeatureID==ID_VOLC_EYEBROW){
            setMakeup("eyebrow/lite/BK01","Internal_Makeup_Brow");
        }else if(selectedFeatureID==ID_VOLC_CIRCLE_LENSES){
            setMakeup("pupil/hunxuezong","Internal_Makeup_Pupil");
        }
    }
    ...
    private void setMakeup(String nodePath,String key){
        File destFile = context.getExternalFilesDir("assets");
        File strModelDir = new File(destFile, "bytedance/Resource/ComposeMakeup.bundle/ComposeMakeup/" + nodePath);
    ...
    private void setSticker(String nodePath){
        try {
            JSONObject jsonObject = new JSONObject();
            jsonObject.put("strPath", context.getExternalFilesDir("assets")
                + "/bytedance/Resource/StickerResource.bundle/stickers/"+ nodePath);
