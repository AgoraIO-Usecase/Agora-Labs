...
object TokenGenerator {
   ...
   public fun generateToken(
    ...
    private suspend fun fetchToken(
        ...
        postBody.put("appId",  AESUtils.getS1(App.getInstance()))
        postBody.put("appCertificate", AESUtils.getS2(App.getInstance()))
        ...
        val request = Request.Builder().url(
            if (genType == TokenGeneratorType.token006) "https://service.shengwang.cn/toolbox/v2/token/generate"
            else "https://service.shengwang.cn/toolbox/v2/token/generate"
