...
class SuperClarity: BaseViewController {
    
    var currentModel:SubCellModel?
    var currentBlend:Int = 256
    ...
    let itemModelList:[SubCellModel] = [
        ...
        SubCellModel(name: "1080P",tag: 4,value: AgoraVideoEncoderConfiguration(size: CGSize(width: 1080, height: 1920), frameRate: .fps15, bitrate: 3150, orientationMode: .fixedPortrait, mirrorMode: .auto))
    ]
    ...
    lazy var remoteVideoView: AGContrastView = {
        ...
        _remoteVideoView.selectTitle = "超级画质开启"
        _remoteVideoView.title = "超级画质未开启"
    ...
    func setupSuperResolutionBlend(blend:Int = 0) {
        
    }
}

extension SuperClarity:AgoraMediaFilterEventDelegate,AgoraRtcEngineDelegate{
