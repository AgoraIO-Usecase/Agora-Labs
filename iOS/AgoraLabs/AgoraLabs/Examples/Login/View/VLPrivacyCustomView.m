...
- (UIButton *)disButton {
    if (!_disButton) {
        ...
        if(_pass == 0) {
            [_disButton setTitle:@"不同意" forState:UIControlStateNormal];
        }
        else {
            [_disButton setTitle:@"不同意并退出" forState:UIControlStateNormal];
        }
...
- (UIButton *)agreeButton {
    if (!_agreeButton) {
        ...
        if(_pass == 0) {
            ...
            [_agreeButton setTitle:@"同意并继续" forState:UIControlStateNormal];
        }
