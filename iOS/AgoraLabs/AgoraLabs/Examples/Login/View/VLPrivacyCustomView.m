...
- (UIButton *)disButton {
    if (!_disButton) {
        ...
        if(_pass == 0) {
            [_disButton setTitle:AGLocalizedString(@"bty") forState:UIControlStateNormal];
        }
        else {
            [_disButton setTitle:AGLocalizedString(@"bty") forState:UIControlStateNormal];
        }
...
- (UIButton *)agreeButton {
    if (!_agreeButton) {
        ...
        if(_pass == 0) {
            [_agreeButton setTitle:AGLocalizedString(@"ty") forState:UIControlStateNormal];
        }
        else {
            [_agreeButton setTitle:AGLocalizedString(@"ty") forState:UIControlStateNormal];
        }
