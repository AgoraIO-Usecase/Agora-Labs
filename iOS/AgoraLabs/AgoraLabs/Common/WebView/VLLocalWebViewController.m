...
- (void)setUpUI {
    self.view.backgroundColor = [UIColor colorWithRGB:0xF7FAFE];
    WKWebViewConfiguration * configuration = [[WKWebViewConfiguration alloc]init];
    configuration.allowsInlineMediaPlayback = YES;
    configuration.mediaTypesRequiringUserActionForPlayback = WKAudiovisualMediaTypeAll;
    CGFloat y = IPHONE_X ? 15 : 0;
    self.webViewWK = [[WKWebView alloc]initWithFrame:CGRectMake(0, kStatusBarHeight - y, kScreenWidth, kScreenHeight - kSafeAreaBottomHeight - y) configuration:configuration];
    self.webViewWK.scrollView.backgroundColor = [UIColor colorWithRGB:0xF7FAFE];
    self.webViewWK.backgroundColor = [UIColor colorWithRGB:0xF7FAFE];
